                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        width: _deviceWidth * 0.15,
                        height: dataTps.resultPerTps.values.length * (_4deviceHeight * 0.11),
                        decoration: BoxDecoration(
                          color: Theme.of(context).primaryColor,
                          border: Border.all(
                            width: 1,
                          ...
                          children: [
                            Expanded(
                              child: ListView.builder(
                                itemCount: dataTps.resultPerTps.values.length,
                            ...
                            Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index)=> Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text('${dataTps.resultPerTps.values.toList()[index].name}'),
                                ),
                                ),
                            ),
                          ],
                            ...
                            Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index)=> Center(
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text('${dataTps.resultPerTps.values.toList()[index].suara}'),
                                  ),
                                  ),
                                ),
                            ),
